...
## Initial setup
1. `git clone --recurse-submodules` this repository to your home dir (can be cloned to another dir too, but in that case you need to use `-t ~` with every stow command)
